...
class GameSnapshot(Base):
    ...
    id: Mapped[str] = mapped_column(String, primary_key=True, default=generate_uuid)
    room_id: Mapped[str] = mapped_column(String, ForeignKey("game_rooms.id"), unique=True)
...
class MoveHistory(Base):
    ...
    id: Mapped[str] = mapped_column(String, primary_key=True, default=generate_uuid)
    room_id: Mapped[str] = mapped_column(String, ForeignKey("game_rooms.id"), index=True)
